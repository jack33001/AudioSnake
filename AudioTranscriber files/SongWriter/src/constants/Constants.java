...
public class Constants {
	...
	public static final String WAVFILE_LOCATION = "samples/Can't Let Go.wav";
	...
	public static final double ENERGY_PULSE_CONSTANT = 1.2; //how much higher local instant sound energy must be than local average sound energy to register a beat
	/*
